...
def index(request):
    ...
    return render(request, "sem3app1/index.html", context)
...
def about(request):
    ...
    return render(request, "sem3app1/about.html", context)
...
def flip_coin(request, tryes: int):
    ...
    return render(request, "sem3app1/games.html", context)
...
def articles(request, id_author: int = None):
    ...
    return render(request, "sem3app1/articles.html", context)
...
def full_article(request, id_article: int):
    ...
    return render(request, "sem3app1/full_article.html", context)
...
def orders(request, client_id: int = None):
    ...
    return render(request, 'sem3app1/orders.html', context)
